...
export const OFFERS: Array<Offer> = [
  {
    ...
    image: { src: 'sueter/1.jpg', alt: 'Sueter 1' },
    gallery: [
      { src: 'sueter/1.jpg', alt: 'Sueter 1' },
      { src: 'sueter/2.jpg', alt: 'Sueter 2' },
      { src: 'sueter/3.jpg', alt: 'Sueter 3' }
    ],
    sell_price: 111.55,
    available: true,
    stock_qty: 3
  },
  {
    ...
    image: { src: 'adidas/1.jpg', alt: 'Adidas 1' },
    gallery: [
      { src: 'adidas/1.jpg', alt: 'Adidas 1' },
      { src: 'adidas/2.jpg', alt: 'Adidas 2' },
      { src: 'adidas/3.jpg', alt: 'Adidas 3' }
    ],
    sell_price: 105.2,
    available: true,
    stock_qty: 2
